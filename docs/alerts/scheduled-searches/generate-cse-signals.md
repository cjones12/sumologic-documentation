...
* `description`. This field should contain a description of what the scheduled search provides. This is up to the user but a good rule of thumb is to keep the description to a minimum (less than 50 characters).
